...
about the solution for the third problem, but that isn't enough, so the friends
won't take it.
...
// input the number of inputs such that each input has 3 integer, either 0 or 1,
// if count of 1 in each line >1 then implement++ return implement
